...
### Notations of $F_{IT}$, $F_{ST}$, $F_{IS}$
...
High $F_{ST}$ means high variance of genes among subpopulations (high $\sigma^2_a$), meaning that subpopulations have more different genes from each other.
